...
export function Hero() {
  return (
    ...
    >
        ...
        >
          <div className="h-[85%] w-auto min-w-[200px] max-w-[min(380px,50vw)] flex items-end">
            <Image
              ...
              width={380}
              height={475}
              className="scale-x-[-1] object-contain object-left object-bottom drop-shadow-2xl w-full h-full"
            />
          </div>
        </div>
      ...
      {/* Content — z-20 so title stays above the full-bleed background layer */}
      <div className="relative z-20 mx-auto max-w-7xl px-4 pt-8 pb-16 sm:px-6 lg:px-8 lg:pt-10 lg:pb-24 flex flex-col items-start text-left">
